...
from tello_key_controller import TelloKeyboardController
...
def get_args():
    ...
    # Add a command-line argument to specify the config file
    parser.add_argument('-c', '--my-config', required=False, help='config file path')
...
def main():
    ...
    while True:
        ...
        debug_image, gesture_id = gesture_detector.predict(image, number, mode)
